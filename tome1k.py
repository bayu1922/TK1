...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EpfByTmHyYfs9tOLelLe./YLQOgIZ+sj+8fIgzRvH+G.B6GV6EH0R0wtLLC1YDjcsUdknL30NbJbbng1LseJiZs=')
nadya.loginResult()
...
╚═══════════════════
"""
tjia="ufb296aa068b3fd227ff0588666b561fe"
...
Bots=[mid]
Creator=["ue0d25974d7242e56c49ad1d2e5b118e4","u1b480d0529ae8b99ac6747b25db83dc7","u9a8e33dd2ae1007de2551138193c1783"]
admin=["u387b20fdf90759f891c8f697c5e41c90","ue0d25974d7242e56c49ad1d2e5b118e4","u1b480d0529ae8b99ac6747b25db83dc7","u9a8e33dd2ae1007de2551138193c1783"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By :TOMEBOTLINE☺️ .",    
    "commentOn":True,
    "commentBlack":{},
...
def bot(op):
    try:
		...
		nadya.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                admin2 = "u387b20fdf90759f891c8f697c5e41c90"
                admin3 = ""
                msg.contentMetadata = {'mid': tjia}
                nadya.sendMessage(msg)
		...
		nadya.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["บอท","ต้อม","ตาต้อม"]:
                        nadya.sendText(msg.to,"จ๋า ว่าไงงับๆ")
            elif msg.text in ["ท้าว","คนสวย","ไข่ดาว"]:
                        nadya.sendText(msg.to,"ท้าวไม่ว่างจ้า เครียเงินอยู่ คุยกับบอทก็ได้นะ ฮิ")
            elif msg.text in ["ลงวง","มาลงวงกัน","มาๆ"]:
                        nadya.sendText(msg.to,"ให้ใวๆ เดี่ยวจะมืดค่ำกันก่อน 😅😅😅")
            elif msg.text in ["ควย","สัตว์","เหี้ย"]:
                        nadya.sendText(msg.to,"อ้าวเฺฮ้ย ที่นี้ไม่ใช่สวนสัตว์นะ \n จะได้มีหมูหมากาไก่ โง่นะมึงอะสาสสส")
            elif msg.text in ["ส่งยอดด้วยนะ","ส่งยอดกันด้วย","ส่งยอด"]:
                        nadya.sendText(msg.to,"เวลารับเงินอะใวกันจังนะพวกมึง \n แต่พอเวลาส่งอะช้ากันชิบหายเลย อย่าให้พูดนะ \n (งอน)โตๆกันแล้ว")
            elif msg.text in ["สวัสดีจ้า","ดีจ้า","หวัดดี"]:
                        nadya.sendText(msg.to,"เอ้อ.....กองใว้ตรงนั้นแหละสาส")
            elif msg.text in ["ฝันดีจ้า","ฝันดี","ฝันดีค่ะ","ฝันดีครับ"]:
                        nadya.sendText(msg.to,"ห๊ะ.....กูฝันเบียกอยู่วุ้ย")
            elif msg.text in ["อะไร","ว่า","อะไรหรอค่ะ"]:
                        nadya.sendText(msg.to,"เปล่า....ถามหาคนน่ารักเฉยๆ")
            elif msg.text in ["เยสเข้"]:
                        nadya.sendText(msg.to,"อิอิ เยสพ่องสิสาสสส")
            elif msg.text in ["เจริญล่ะ"]:
                        nadya.sendText(msg.to,"สาธุๆ\nสมพรปากนะ (อธิษฐาน)")
            elif msg.text in ["จะบ้าตาย"]:
                        nadya.sendText(msg.to,"(ดีใจ)เย้ๆ ตายซะได้ก็ดี (หัวเราะ)")
            elif msg.text in ["ไปนอนเถอะ","ไปนอน","ควรนอน"]:
                        nadya.sendText(msg.to,"เชิญเลยจ้า\nตามสยาย (หลับ)")
            elif msg.text in ["พักผ่อนนะ","พักนะ","บักบ้าง"]:
                        nadya.sendText(msg.to,"(ตกลง)จ้าได้เลย\n นานๆเลยนะ สวดวัดใหนหรอ(หัวเราะ)")
            elif msg.text in ["เปนลม","เป็นลม","จะเป็นลม","เป็นลมแป๊บ"]:
                        nadya.sendText(msg.to,"เป็นลมบ้าไร \n นี้ฝนกำลังจะตกแล้วสาส")
            elif msg.text in ["เพ้อ"]:
                        nadya.sendText(msg.to,"ยุ่งไรไม่เข้าเรื่อง\n  ไปหาไรทำไป���ถ้าว่างมากก็เอาหัสโขกกำแพงเล่นซะนะ (ไม่)")
            elif msg.text in ["หนักละ","อาการหนักละ","หนักนะเรา"]:
                        nadya.sendText(msg.to,"(สวย) มันเรื่อวของฉ๊าน (งอน)")
            elif msg.text in ["สบายดีใหม","สบายดีหรอ","เป็นไงมั้ง"]:
                        nadya.sendText(msg.to,"(สบาย)แบบว่า สบายดีมากๆเลยอ่ะ(สวัสดี)")
            elif msg.text in ["พักแป๊บ","พัก","พักแปบ"]:
                        nadya.sendText(msg.to,"(เปิด)เชิญ..ตามสบายเลยจ้า \n ชอบหลุม���หนไปหลุมนั้นเลยนะ 😲")
            elif msg.text in ["หิว","หิวข้าว","กินข้าว"]:
                        nadya.sendText(msg.to,"       บอกเพื่อ \n หิวก็ไปกิน หรื่อจะให้ป้อน!!!!! \n  (ปัดโถ้ 🗿")
            elif msg.text in ["ปวดหัว"]:
                        nadya.sendText(msg.to,"ใช่หรอ 🔕 \n ไม่ใช่อยากได้ผัววววหรา 😅 \n หาผัวเถอะหนู (ลิง)")
            elif msg.text in ["กวนตีน","กวน"]:
                        nadya.sendText(msg.to,"เชิญรับยาที่ช่อง2 ค่ะ \n หนักล่ะนะคุณเมิง😲")
            elif msg.text in ["หวัดดีฮ่ะ"]:
                        nadya.sendText(msg.to,"(เอ๊ะ) เอ้อ......กองใว้ตรงนั้นละ 🔐")
            elif msg.text in ["เอ้ามาลงวงโว้ย","มาลงวง","ลงวง"]:
                        nadya.sendText(msg.to,"☠อย่าเสือก......(ปืน) \n อยากลงก็ลงเองสิ งิ 😨")
		...
		if msg.from_ in admin:
                    ...
                    wait["Qr"] = False
                    wait["Ghost"] = False                    
                    nadya.sendText(msg.to,"Auto cancel set to off😨")
                    nadya.sendText(msg.to,"Invite protect set to off😨")
                    nadya.sendText(msg.to,"Auto kick set to off😨")
                    nadya.sendText(msg.to,"Protect QR set to off😨")
                    nadya.sendText(msg.to,"คิกผี ปิดใช้งานแล้ว 😨")
		else:
		    nadya.sendText(msg.to,"OK")
                ...
                wait["Contact"] = True
                nadya.sendText(msg.to,"Contact ถูกเปิดใล้งาน😲")

            elif msg.text in ["K off","Contact off"]:
                wait["Contact"] = False
                nadya.sendText(msg.to,"Contact ถูกปิดใช้งานแล้ว👌")
...
#======================== FOR COMMAND MODE ON STARTING ==========================#
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protecion Already On")
                    else:
                        nadya.sendText(msg.to,"Protecion Already On")
                else:
                    wait["protect"] = True
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protection Qr already On")
                    else:
                        nadya.sendText(msg.to,"Protection Qr already On")
                else:
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protection Invite already On")
                    else:
                        nadya.sendText(msg.to,"Protection Invite already On")
                else:
                    wait["inviteprotect"] = True
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"ρяσтє¢тισи ιиνιтє ѕєт тσ σи")
                    else:
                        nadya.sendText(msg.to,"ρяσтє¢тισи ιиνιтє αℓяєα∂у σи")
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ѕєт тσ σи")
                    else:
                        nadya.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи αℓяєα∂у σи")
                else:
...
#======================== FOR COMMAND MODE OFF STARTING ==========================#
                ...
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protection already Off")
                    else:
                        nadya.sendText(msg.to,"Protection already Off")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"ρяσтє¢тισи ѕєт тσ σff")
                    else:
                        nadya.sendText(msg.to,"ρяσтє¢тισи αℓяєα∂у σff")
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protection Qr already off")
                    else:
                        nadya.sendText(msg.to,"Protection Qr already off")
                else:
                ...
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protection Invite already Off")
                    else:
                        nadya.sendText(msg.to,"Protection Invite already Off")
                else:
                    wait["inviteprotect"] = False
                ...
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Protection Cancel already Off")
                    else:
                        nadya.sendText(msg.to,"Protection Cancel already Off")
                else:
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ ση")
                    else:
                        nadya.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ ση")
                else:
                    wait["contact"] = True
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ σƒƒ")
                    else:
                        nadya.sendText(msg.to,"ɕσηϯαɕϯ αʆɾεαδψ σƒƒ")
                else:
                    wait["contact"] = False
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"ɕσηϯαɕϯ ςεϯ ϯσ σƒƒ")
                ...
                if wait["inviteprotect"] == True:
                    ...
                    wait["inviteprotect"] = True
                    if wait["lang"] == "JP":
                        nad.sendText(msg.to,"ρяσтє¢тισи ιиνιтє ѕєт тσ σи")
                    else:
                        nadya.sendText(msg.to,"ρяσтє¢тισи ιиνιтє αℓяєα∂у σи")
                ...
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"αυтσʝσιи ѕєт тσ σи")
                    else:
                        nadya.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σи")
                else:
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"αυтσʝσιи ѕєт тσ σи")
                ...
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"αυтσʝσιи ѕєт тσ σff")
                    else:
                        nadya.sendText(msg.to,"αυтσʝσιи αℓяєα∂у σff")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"αυтσʝσιи ѕєт тσ σff")
                ...
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            nadya.sendText(msg.to,"Itu off undangan ditolak??\nSilakan kirim dengan menentukan jumlah orang ketika Anda menghidupkan")
                        else:
                            nadya.sendText(msg.to,"Off undangan ditolak??Sebutkan jumlah terbuka ketika Anda ingin mengirim")
                    else:
                        num =  int(strnum)
                        wait["autoCancel"]["on"] = True
                        if wait["lang"] == "JP":
                            nadya.sendText(msg.to,strnum + "Kelompok berikut yang diundang akan ditolak secara otomatis")
                        else:
                            nadya.sendText(msg.to,strnum + "The team declined to create the following automatic invitation")
                except:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Nilai tidak benar")
                    else:
                        nadya.sendText(msg.to,"Weird value")
            elif msg.text.lower() == 'autoleave on':
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Auto Leave room set to on")
                    else:
                        nadya.sendText(msg.to,"Auto Leave room already on")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Auto Leave room set to on")
                ...
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Auto Leave room set to off")
                    else:
                        nadya.sendText(msg.to,"Auto Leave room already off")
                else:
                ...
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Share set to on")
                    else:
                        nadya.sendText(msg.to,"Share already on")
                else:
                    wait["timeline"] = True
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Share set to on")
                ...
                if wait["timeline"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Share set to off")
                    else:
                        nadya.sendText(msg.to,"Share already off")
                else:
                    wait["timeline"] = False
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Share set to off")
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text.lower() in ["lucu","ngakak","เหนื่อย"]:
                msg.contentType = 7
            ...
            elif msg.text.lower() in ["hmm","หื้ม"]:
                msg.contentType = 7
            ...
            elif msg.text.lower() in ["ok","oke","โอเคร","oce","okee","sip","siph"]:
                msg.contentType = 7
...
#==============================================================================#
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "ufb296aa068b3fd227ff0588666b561fe"
                nadya.inviteIntoGroup(msg.to,[midd])
